...
import (
	...
	servicev1alpha1 "service-cache-operator/pkg/apis/service/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &servicev1alpha1.Service{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &servicev1alpha1.Service{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &servicev1alpha1.Service{}
...
func newPodForCR(cr *servicev1alpha1.Service) *corev1.Pod {
